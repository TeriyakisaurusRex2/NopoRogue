...
var AREA_DEFS=[
  ...
  // {id:'shattered_vault', name:'The Shattered Vault', levelRange:[5,8], enemyPool:['cursedurn','iron_sentinel','vaultspectre']},
  ...
  // {id:'mistwood',    name:'The Mistwood',    levelRange:[2,5], enemyPool:['mistraven','foghast','moonsquirrel','nightentling']},
  ...
  // {id:'sunkenharbour', name:'The Sunken Harbour', levelRange:[2,4], enemyPool:['tidecrab','drownedsailor','inksquall','siren']},
